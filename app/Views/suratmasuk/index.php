                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $data['tujuan']; ?></td>
                                    <td>
                                        <a href="/admin/suratmasuk/edit/<?= $data['nomor']; ?>" class="btn btn-sm btn-warning me-1"><i class="fas fa-edit">Edit</i></a>
                                        <a href="/admin/suratmasuk/delete/<?= $data['nomor']; ?>" class="btn btn-sm btn-danger me-1" onclick="return confirm('Yakin ingin Menghapus?');"><i class="fas fa-trash">Delete</i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
